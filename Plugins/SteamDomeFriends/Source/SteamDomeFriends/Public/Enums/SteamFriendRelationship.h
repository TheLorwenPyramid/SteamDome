...
enum class ESteamFriendRelationship : uint8
{
	...
	Blocked = 1, 				//	The user has just clicked Ignore on a friendship invite. This doesn't get stored.
...
namespace SteamFriendRelationship
{
	inline EFriendRelationship STEAMDOMEFRIENDS_API ToSteamEnum(const ESteamFriendRelationship SteamFriendRelationship)
	{
		return StaticCast<EFriendRelationship>(SteamFriendRelationship);
	}

	inline ESteamFriendRelationship STEAMDOMEFRIENDS_API FromSteamEnum(const EFriendRelationship SteamFriendRelationship)
	{
		return StaticCast<ESteamFriendRelationship>(SteamFriendRelationship);
	}
}
